...
| [`0001-cardano-cips`](https://github.com/xray-network/xray-cardano-lib/blob/main/.agents/spectre/providers/cardano-cips/0001-cardano-cips/SNAPSHOT.md) | `PROVIDER` | Yes | Captured active CIP-21 interoperability rules and explicitly time-sensitive device appendix |
