...
| --- | --- | --- | --- |
| [`0001-message-signing`](https://github.com/xray-network/xray-cardano-lib/blob/main/.agents/spectre/providers/message-signing/0001-message-signing/SNAPSHOT.md) | `PROVIDER` | Yes | CIP-8 wire and signing behavior |
