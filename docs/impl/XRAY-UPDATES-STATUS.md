...
| `0006` | Typed Conway governance construction | [Instruction](./typescript/0006-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0006-IMPL-RESULT.md) | `HYBRID` | AI implementation complete; awaiting human review. |
| `0007` | CIP-14 asset fingerprints | [Instruction](./typescript/0007-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0007-IMPL-RESULT.md) | `HYBRID` | AI implementation complete; awaiting human review. |
| `0008` | Strict identities and HD derivation | [Instruction](./typescript/0008-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0008-IMPL-RESULT.md) | `HYBRID` | AI implementation complete; awaiting human review. |
...
| `0017` | Typed transaction decomposition | [Instruction](./typescript/0017-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0017-IMPL-RESULT.md) | `LOCAL` | AI implementation complete; awaiting human review. |
| `0018` | Required-witness discovery | [Instruction](./typescript/0018-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0018-IMPL-RESULT.md) | `LOCAL` | AI implementation complete; awaiting human review. |
| `0019` | Typed scripts and serialized envelopes | [Instruction](./typescript/0019-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0019-IMPL-RESULT.md) | `LOCAL` | AI implementation complete; awaiting human review. |
| `0020` | Typed phase-two redeemer identity | [Instruction](./typescript/0020-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0020-IMPL-RESULT.md) | `LOCAL` | AI implementation complete; awaiting human review. |
| `0021` | CostModels public consumption identity | [Instruction](./typescript/0021-IMPL-INSTR.md) | `REVIEW` | [Result](./typescript/0021-IMPL-RESULT.md) | `LOCAL` | AI implementation complete; awaiting human review. |
