...
| `0016` | [CIP-4 wallet checksum facade](./0016-IMPL-INSTR.md) | `REVIEW` | [Result](./0016-IMPL-RESULT.md) | `LOCAL` | Canonical CIP-4 checksum calculation, focused and aggregate exports, and the xray-js xpub adapter completed with all library and SDK gates passing; awaiting human decision. |
