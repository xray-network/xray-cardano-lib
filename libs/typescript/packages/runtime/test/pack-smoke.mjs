...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { applyParamsToScript, apply_params_to_script, CIP8Message as AggregateCIP8Message, Constr as AggregateConstr, Data as AggregateData, evaluatePhaseTwoRaw, eval_phase_two_raw } from "@xray-network/xray-cardano-lib";',
      ...
      "    applyParamsToScript !== apply_params_to_script ||",
      "    evaluatePhaseTwoRaw !== eval_phase_two_raw) {",
  ...
  await writeFile(
    ...
    [
      ...
      'import type { CIP8MessageEnvelope, DataSchema, VoidSchema } from "@xray-network/xray-cardano-lib";',
      'import * as chain from "@xray-network/xray-cardano-lib-chain";',
      ...
      "void [cardano, chain, allegra, alonzo, babbage, byron, conway, mary, multiEra, shelley, cip, cip25, cip36, cip8, plutus, uplc, core, crypto, datum, metadata, block, eraBlock, uplcResult, anySchema, cip8Envelope];",
      "",
    ].join("\n"),
  );
