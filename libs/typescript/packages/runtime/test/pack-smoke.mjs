...
const packages = [
  ["core", "@xray-network/cardano-core"],
  ["crypto", "@xray-network/cardano-crypto"],
...
try {
  ...
  await writeFile(
    ...
    [
      ...
      'import { CIP25ChunkableString } from "@xray-network/cardano-cip/cip25";',
      'import { CIP36KeyDeregistration } from "@xray-network/cardano-cip/cip36";',
      'import { COSESign1Builder, HeaderMap, Headers, ProtectedHeaderMap } from "@xray-network/cardano-cip/cip8";',
      'import * as plutus from "@xray-network/cardano-plutus";',
  ...
  await writeFile(
    ...
    [
      ...
      'import * as babbage from "@xray-network/cardano-chain/babbage";',
      'import * as byron from "@xray-network/cardano-chain/byron";',
      'import * as conway from "@xray-network/cardano-chain/conway";',
      'import * as mary from "@xray-network/cardano-chain/mary";',
      'import * as multiEra from "@xray-network/cardano-chain/multi-era";',
      'import * as shelley from "@xray-network/cardano-chain/shelley";',
      'import type { AllegraBlockJSON } from "@xray-network/cardano-chain/allegra";',
      'import type { AlonzoBlockJSON } from "@xray-network/cardano-chain/alonzo";',
      'import type { BabbageBlockJSON } from "@xray-network/cardano-chain/babbage";',
      'import type { ByronBlockJSON } from "@xray-network/cardano-chain/byron";',
      'import type { BlockJSON as ConwayBlockJSON } from "@xray-network/cardano-chain/conway";',
      'import type { MaryBlockJSON } from "@xray-network/cardano-chain/mary";',
      'import type { ShelleyBlockJSON } from "@xray-network/cardano-chain/shelley";',
      'import * as cip from "@xray-network/cardano-cip";',
      'import * as cip25 from "@xray-network/cardano-cip/cip25";',
      'import * as cip36 from "@xray-network/cardano-cip/cip36";',
