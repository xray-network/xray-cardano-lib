...
try {
  ...
  await writeFile(
    ...
    [
      ...
      "void [cardano, chain, allegra, alonzo, babbage, byron, conway, mary, multiEra, shelley, cip, cip25, cip36, cip4, cip8, plutus, uplc, core, crypto, datum, metadata, block, eraBlock, uplcResult, anySchema, cip4Checksum, cip8Envelope];",
      "",
    ].join("\n"),
  );
