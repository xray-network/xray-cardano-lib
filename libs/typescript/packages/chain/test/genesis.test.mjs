...
const inventory = JSON.parse(
  await readFile(
    new URL(
      "../../../../../.agents/spectre/providers/cardano-multiplatform-lib/0001/artifacts/test-vectors/manifest.json",
      import.meta.url,
    ),
    "utf8",
  ),
...
const fixtureRoot = new URL(
  "../../../../../.agents/spectre/providers/cardano-multiplatform-lib/0001/artifacts/test-vectors/",
  import.meta.url,
);
