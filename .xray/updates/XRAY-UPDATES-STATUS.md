...
| `0006` | Typed Conway governance construction | [Instruction](./implementations/typescript/0006-IMPL-INSTR.md) | `PLANNED` | — | `HYBRID` | Awaiting implementation. |
| `0007` | CIP-14 asset fingerprints | [Instruction](./implementations/typescript/0007-IMPL-INSTR.md) | `PLANNED` | — | `HYBRID` | Awaiting implementation. |
| `0008` | Strict identities and HD derivation | [Instruction](./implementations/typescript/0008-IMPL-INSTR.md) | `PLANNED` | — | `HYBRID` | Awaiting implementation. |
