...
| [XRAY Updates adoption decision](../../../../docs/adr/repository/0004-xray-updates-standard.md) | `LOCAL` | Yes | Repository decision to adopt the standard while preserving existing records and evidence. |
